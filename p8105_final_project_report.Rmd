...
Based on this line graph, we can see the number of dogs that had a particular name based on birth year from 2000 to 2015. Names like Coco, Max, and Bella had an increase between 2000 - 2010 while names like Charlie gained popularity starting around 2007 all the way until about 2016. Additionally, while names like Lucky and Lucy were popular, they spanned a short duration of about a year.  An interesting trend is that there has been a decrease in the popularity of the name Luna from 2016. 
